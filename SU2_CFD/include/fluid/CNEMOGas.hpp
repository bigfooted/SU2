...
public:
   ...
   */
  void ComputedPdU(su2double *V, const vector<su2double>& val_eves, su2double *val_dPdU);
   ...
   */
  void ComputedTvedU(su2double *V, const vector<su2double>& val_eves, su2double *val_dTvedU);
